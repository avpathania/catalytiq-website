...
import { INDUSTRIES_SERVED_IT } from "@/lib/constants";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <AnimateOnScroll animation="slideUp" threshold={0.2}>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Costruito per Piccole e Medie Imprese
            </h2>
          </div>
        </AnimateOnScroll>
        ...
        <div className="mx-auto mt-16 max-w-4xl">
          <StaggerContainer
            ...
            threshold={0.1}
          >
            {INDUSTRIES_SERVED_IT.map((industry, index) => {
        ...
        <AnimateOnScroll animation="slideUp" delay={300} threshold={0.3}>
          <div className="mx-auto mt-16 max-w-2xl text-center">
            <p className="text-lg text-muted-foreground">
              Non vedi il tuo settore? Lavoriamo con aziende di tutti i settori.
            </p>
            <div className="mt-6">
              <Link
                href="/it/industries"
