...
import { getFeaturedPosts as getFeaturedPostsIT } from '@/lib/blog-client-it';
import { BLOG_CONFIG } from '@/lib/constants';
import type { BlogPost } from '@/types/blog';

export function BlogHeroIT() {
  ...
  useEffect(() => {
    async function loadFeaturedPosts() {
      try {
        const posts = await getFeaturedPostsIT(BLOG_CONFIG.FEATURED_POSTS_COUNT);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Scopri i nostri ultimi approfondimenti sull'automazione aziendale e la trasformazione digitale
          </p>
        </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center gap-4 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        {new Date(mainPost.published_at!).toLocaleDateString('it-IT')}
                      </span>
                    </div>
                    <div className="flex items-center gap-1">
                      <Clock className="h-4 w-4" />
                      <span>{mainPost.reading_time} min di lettura</span>
                    </div>
                  </div>
                </CardContent>
              </Link>
